...
# Generated on: Tue Nov 07 19:17:08 CST 2023 (Wed Nov 08 01:17:08 UTC 2023)
...
set_log_file fv/odometer_full_hvt/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/odometer_full_hvt -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ROSC_ALL_HVT.v rosc_block_top_pwr_hvt_ref.v rosc_block_top_pwr_hvt_stress.v odometer_top.v shift_sample_3b.v edge_detector.v signal_ctrl.v power_enable.v parallel_latch.v odometer_meas_detect.v odometer_full_hvt.v
elaborate_design -golden -root {odometer_full_hvt} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/odometer_full_hvt/fv_map.v.gz
elaborate_design -revised -root {odometer_full_hvt}
...
#add_name_alias fv/odometer_full_hvt/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/odometer_full_hvt/rtl_to_fv_map.log
}
