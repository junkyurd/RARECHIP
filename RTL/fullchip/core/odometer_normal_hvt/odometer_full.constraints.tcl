...
create_clock -name DETECT -period $DETECT_period [get_pin odometer_top_odometer_meas_detect_inst/DETECT]
...
set_dont_touch [get_cells rosc_stress_ROSC_INV/*] true
set_dont_touch [get_cells rosc_stress_ROSC_NAND/*] true
set_dont_touch [get_cells rosc_stress_ROSC_NOR/*] true
set_dont_touch [get_cells rosc_ref_ROSC_INV/*] true
set_dont_touch [get_cells rosc_ref_ROSC_NAND/*] true
set_dont_touch [get_cells rosc_ref_ROSC_NOR/*] true
...
# create_clock -name OUT_INV_stress  -period $OSC_period2 [get_pins rosc_stress_ROSC_INV/genblk1[100].INV1/ZN ]
# create_clock -name OUT_NAND_stress -period $OSC_period4 [get_pins rosc_stress_ROSC_NAND/genblk1[100].NAND/ZN ]
# create_clock -name OUT_NOR_stress  -period $OSC_period6 [get_pins rosc_stress_ROSC_NOR/genblk1[100].NOR/ZN ]
# create_clock -name OUT_INV_ref     -period $OSC_period1 [get_pins rosc_ref_ROSC_INV/RO[102].INV1/ZN ]
# create_clock -name OUT_NOR_ref     -period $OSC_period3 [get_pins rosc_ref_ROSC_NAND/genblk1[102].NAND/ZN ]
# create_clock -name OUT_NAND_ref    -period $OSC_period5 [get_pins rosc_ref_ROSC_NOR/genblk1[102].NOR/ZN] 

create_clock -name OUT_INV_stress  -period $OSC_period_inv_stress [get_pins rosc_stress_ROSC_INV/\genblk1.inv[99].INV/ZN]
create_clock -name OUT_NAND_stress -period $OSC_period_nand_stress [get_pins rosc_stress_ROSC_NAND/\genblk1.nd[99].NAND/ZN]
create_clock -name OUT_NOR_stress  -period $OSC_period_nor_stress [get_pins rosc_stress_ROSC_NOR/\genblk1.nr[99].NOR/ZN]
create_clock -name OUT_INV_ref     -period $OSC_period_inv_ref [get_pins rosc_ref_ROSC_INV/\genblk1.inv[101].INV/ZN]
create_clock -name OUT_NOR_ref     -period $OSC_period_nor_ref [get_pins rosc_ref_ROSC_NOR/\genblk1.nr[101].NOR/ZN]
create_clock -name OUT_NAND_ref    -period $OSC_period_nand_ref [get_pins rosc_ref_ROSC_NAND/\genblk1.nd[101].NAND/ZN]


set_false_path -from [get_ports RESETB ]
#set_false_path -from [get_pins *DEADZONE_ESCAPE_COUNTER*/*] -to [get_pins {odometer_top_odometer_meas_detect_inst/g891__2398/ZN}] 
#set_false_path -from [get_pins {odometer_top_odometer_meas_detect_inst/g891__2398/ZN}] -to  [get_pins *DEADZONE_ESCAPE_COUNTER*/*]
