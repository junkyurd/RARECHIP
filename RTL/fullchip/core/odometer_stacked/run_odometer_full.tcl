...
read_hdl { ./ROSC_ALL_RVT_stacked.v 
...
elaborate
current_design odometer_full_stacked_rvt
#set_db [get_db design:ring_Osci_31 .modules *] .ungroup_ok false

set_dont_touch {ROSC*_SEL* *pwr_control*}

read_sdc ./odometer_full_stacked.constraints_genus.tcl
...
#write_design -innovus -base_name "./odometer_full_stacked_ver4_syn/odometer_full_stacked_ver4_syn"
write_hdl > odometer_full_stacked_rvt.vg
