...
#set_dont_touch [get_cells rosc_stress/ROSC_INV99/*] true
#set_dont_touch [get_cells rosc_stress/ROSC_INV101/*] true
#set_dont_touch [get_cells rosc_stress/ROSC_INV97/*] true
...
set OSC_period_inv  0.7

# create_clock -name OUT_INV99_stress  -period $OSC_period2 [get_pins rosc_stress/ROSC_INV99/genblk1[100].INV1/ZN ]
# create_clock -name OUT_INV101_stress -period $OSC_period4 [get_pins rosc_stress/ROSC_INV101/genblk1[100].NAND/ZN ]
# create_clock -name OUT_INV97_stress  -period $OSC_period6 [get_pins rosc_stress/ROSC_INV97/genblk1[100].NOR/ZN ]
# create_clock -name OUT_INV99_ref     -period $OSC_period1 [get_pins rosc_ref/ROSC_INV99/RO[102].INV1/ZN ]
# create_clock -name OUT_INV97_ref     -period $OSC_period3 [get_pins rosc_ref/ROSC_INV101/genblk1[102].NAND/ZN ]
# create_clock -name OUT_INV101_ref    -period $OSC_period5 [get_pins rosc_ref/ROSC_INV97/genblk1[102].NOR/ZN] 

# create_clock -name OUT_INV99_stress  -period $OSC_period_INV99_stress [get_pins rosc_stress/ROSC_INV99/genblk1.inv*/ZN]
# create_clock -name OUT_INV101_stress -period $OSC_period_INV101_stress [get_pins rosc_stress/ROSC_INV101/genblk1.inv*/ZN]
# create_clock -name OUT_INV97_stress  -period $OSC_period_INV97_stress [get_pins rosc_stress/ROSC_INV97/genblk1.inv*/ZN]
# create_clock -name OUT_INV99_ref     -period $OSC_period_INV99_ref [get_pins rosc_ref/ROSC_INV99/genblk1.inv*/ZN]
# create_clock -name OUT_INV97_ref     -period $OSC_period_INV97_ref [get_pins rosc_ref/ROSC_INV97/genblk1.inv*/ZN]
# create_clock -name OUT_INV101_ref    -period $OSC_period_INV101_ref [get_pins rosc_ref/ROSC_INV101/genblk1.inv*/ZN]
