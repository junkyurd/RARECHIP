...
# Generated on: Mon Nov 06 11:40:45 CST 2023 (Mon Nov 06 17:40:45 UTC 2023)
...
set_log_file fv/VCO_full/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/VCO_full -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ROSC101_SEL_INV.v buff_block_vco.v freq_div_3b.v freq_div_12b.v VCO_full.v
elaborate_design -golden -root {VCO_full} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/VCO_full/fv_map.v.gz
elaborate_design -revised -root {VCO_full}
...
#add_name_alias fv/VCO_full/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/VCO_full/rtl_to_fv_map.log
}
