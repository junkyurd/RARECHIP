...
# Generated on: Tue Nov 07 18:36:48 CST 2023 (Wed Nov 08 00:36:48 UTC 2023)
...
set_log_file fv/odometer_full_lvt/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/odometer_full_lvt -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ROSC_ALL_LVT.v rosc_block_top_pwr_lvt_ref.v rosc_block_top_pwr_lvt_stress.v odometer_top.v shift_sample_3b.v edge_detector.v signal_ctrl.v power_enable.v parallel_latch.v odometer_meas_detect.v odometer_full_lvt.v
elaborate_design -golden -root {odometer_full_lvt} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/odometer_full_lvt/fv_map.v.gz
elaborate_design -revised -root {odometer_full_lvt}
...
#add_name_alias fv/odometer_full_lvt/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box INVD2BWP30P140LVT TIEHBWP30P140LVT ND2D2BWP30P140LVT TIELBWP30P140LVT NR2D2BWP30P140LVT AN2D2BWP30P140LVT INVD8BWP30P140LVT -golden
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/odometer_full_lvt/rtl_to_fv_map.log
}
