...
# Generated on: Sat Nov 04 01:45:40 CDT 2023 (Sat Nov 04 06:45:40 UTC 2023)
...
set_log_file fv/odometer_full_rvt/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/odometer_full_rvt -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ROSC_ALL_RVT.v rosc_block_top_pwr_rvt_ref.v rosc_block_top_pwr_rvt_stress.v odometer_top.v shift_sample_3b.v edge_detector.v signal_ctrl.v power_enable.v parallel_latch.v odometer_meas_detect.v odometer_full_rvt.v
elaborate_design -golden -root {odometer_full_rvt} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/odometer_full_rvt/fv_map.v.gz
elaborate_design -revised -root {odometer_full_rvt}
...
#add_name_alias fv/odometer_full_rvt/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/odometer_full_rvt/rtl_to_fv_map.log
}
