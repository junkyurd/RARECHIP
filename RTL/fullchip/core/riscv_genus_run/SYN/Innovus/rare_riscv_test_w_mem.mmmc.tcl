...
create_library_set -name default_emulate_libset_max \
    -timing { /project/chriskim07/PDKs/TSMC28nm/sclib/TSMCHOME/digital/Front_End/timing_power_noise/NLDM/tcbn28hpcplusbwp30p140_180a/tcbn28hpcplusbwp30p140tt0p9v25c.lib \
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { ./SYN/Innovus/rare_riscv_test_w_mem.default_emulate_constraint_mode.sdc }
