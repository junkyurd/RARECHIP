...
# Generated on: Mon Nov 27 22:12:38 CST 2023 (Tue Nov 28 04:12:38 UTC 2023)
...
set_log_file fv/rare_riscv_test_w_mem/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/rare_riscv_test_w_mem -revised fv_map
...
add_notranslate_modules -library -both TS1N28HPCPSVTB2048X32M4SW

add_search_path . /apps/cadence/genus_19.1/tools.lnx86/lib/tech -library -both
read_library -liberty -both -cpf run_rare_riscv_test_w_mem.cpf
...
#add_name_alias fv/rare_riscv_test_w_mem/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/rare_riscv_test_w_mem/rtl_to_fv_map.log
}
